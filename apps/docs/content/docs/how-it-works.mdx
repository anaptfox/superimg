...
|----------|---------|----------|----------|
| `ctx.timeline.frame` | 0 | 45 | 89 |
| `ctx.timeline.seconds` | 0.0 | 1.5 | 2.97 |
| `ctx.timeline.progress` | 0.0 | 0.5 | 0.99 |
...
The standard library covers more than `director`, `interpolate`, and `css` — see [Animation Basics](/docs/animation) for motion primitives and [Timing With Director And Cues](/docs/timing) for audio sync and cues.

## Next Steps

- [CLI Reference](/docs/cli) — Commands for creating and rendering media
