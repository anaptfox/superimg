...
`<Player>` supports lazy loading (`loadMode="lazy"`), hover-to-play (`hoverBehavior="play"`), and imperative control via refs. See the [blog post](/blog/introducing-superimg-react) for a full walkthrough of the React layer.
