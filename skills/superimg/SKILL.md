...
description: >
  ...
  "render HTML to MP4/PNG/GIF/SVG", "use define()", "work with ctx.std",
  or mentions SuperImg, video generation, or programmatic media. Provides the
  SuperImg framework for HTML/CSS templates in *.media.ts files.
---
