...
Codex CLI plugin for SuperImg. Distributes the canonical SuperImg skill through OpenAI's [Codex plugin system](https://developers.openai.com/codex/plugins/build).
...
After install, Codex automatically loads the SuperImg skill (mental model + cheat sheet + references + examples).
