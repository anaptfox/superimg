...
const SUPERIMG_VERSION: string = (() => {
  if (typeof __SUPERIMG_VERSION__ !== "string" || !__SUPERIMG_VERSION__) {
    throw new Error(
      "SUPERIMG_VERSION not injected at build time. Rebuild @superimg/cli.",
    );
  }
  return __SUPERIMG_VERSION__;
})();
