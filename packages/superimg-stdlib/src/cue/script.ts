import type { ScriptEvent, ScriptSync, CueEvent } from './types';
 ...
 * const opacity = std.interpolate(heroIn.progress, [0, 1], [0, 1], "easeOutCubic");
 *
 * // What's playing now?
...
export function script(events: ScriptEvent[], time: number): ScriptSync {
  ...
  function buildEvent(id: string): CueEvent {
