...
// Demonstrates: std.layers(), std.score(), std.stagger(), std.css.column()
...
export default defineScene({
  ...
  render(ctx) {
    ...
    const t = std.score({ enter: "0.75s", hold: "2.5s", exit: "0.75s" });
    const enterP = std.stagger(3, t.within("enter"), { duration: 0.5, easing: "easeOutCubic" });
    const exitP = std.stagger(3, t.within("exit"), { duration: 0.5, from: "end", easing: "easeInCubic" });
