      ...
      <div style={{ maxWidth: "100%", padding: "24px 16px" }}>
        ...
        >
          {videos.map((video) => (
            ...
            >
              ...
              >
                {/* Player fills container, scales via CSS transform */}
                <Player
                  ref={(ref) => {
                    if (ref) {
        ...
        >
          <h2 style={{ marginTop: 0, marginBottom: "24px" }}>
            Basic Player with Built-in Controls
          </h2>
          <div style={{ maxWidth: "640px", aspectRatio: "16/9" }}>
            <Player
              ...
              loadMode="eager"
              controls
              style={{ borderRadius: "8px", overflow: "hidden", width: "100%", height: "100%" }}
            />
          </div>
        </div>
      </div>
