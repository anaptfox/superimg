...
import type { KaraokeData, TimedWord } from "./timing";

export type { KaraokeData, TimedWord };

/** Single source of truth for Player + export duration. */
export function calculateKaraokeDuration(data: KaraokeData): number {
...
export const karaokeTemplate = define<KaraokeData>({
  sample: SAMPLE,
