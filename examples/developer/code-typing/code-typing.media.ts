...
export default define<CodeTypingData>({
  sample: {
...
console.log(greet("World"));`,
  ...
  render(ctx: RenderContext<CodeTypingData>) {
    ...
    const headerProgress = t.in("header", { easing: "easeOutCubic" });
    const codeProgress = t.in("code");
    const highlightProgress = t.in("pulse");
